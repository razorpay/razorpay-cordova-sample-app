...
export declare const attachComponent: (delegate: FrameworkDelegate | undefined, container: Element, component?: ComponentRef | undefined, cssClasses?: string[] | undefined, componentProps?: {
  [key: string]: any;
} | undefined, inline?: boolean | undefined) => Promise<HTMLElement>;
