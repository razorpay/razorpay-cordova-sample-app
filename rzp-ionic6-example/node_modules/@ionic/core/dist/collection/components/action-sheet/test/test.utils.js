...
export const testActionSheet = async (type, selector, rtl = false, afterScreenshotHook) => {
  try {
...
export const testActionSheetBackdrop = async (page, screenshotCompares, actionSheet) => {
  try {
...
export const testActionSheetAlert = async (page, screenshotCompares) => {
